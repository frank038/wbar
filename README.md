...
The volume-app-gtk3 tray applet works only if launched from terminal. It doesn't work if executed from autostart methods (I don't know why that issue happens).
